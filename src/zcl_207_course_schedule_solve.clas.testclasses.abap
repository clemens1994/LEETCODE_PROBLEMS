...
CLASS ltcl_207 DEFINITION FOR TESTING
  DURATION SHORT
  RISK LEVEL HARMLESS
.
...
*?</asx:abap>
  PRIVATE SECTION.
    ...
    CLASS-DATA:
      f_cut TYPE REF TO zcl_207_course_schedule_solve.  "class under test
...
CLASS ltcl_207 IMPLEMENTATION.
  ...
  METHOD test_minimal.
    DATA: numcourses    TYPE i VALUE 1,
          ...
          prerequisite  TYPE zst_207_tuple.
  ...
  METHOD test_cyclic_prerequisites.
    DATA: numcourses    TYPE i VALUE 2,
          prerequisites TYPE ztt_207_tuple,
          result        TYPE abap_bool,
          prerequisite1 TYPE zst_207_tuple,
          prerequisite2 TYPE zst_207_tuple.
  ...
  METHOD test_single_multiple_prereq.
    DATA: numcourses    TYPE i VALUE 1,
          ...
          prerequisite1 TYPE zst_207_tuple,
          prerequisite2 TYPE zst_207_tuple,
          prerequisite3 TYPE zst_207_tuple.
    "
